...
const UserDropdown = () => {
  ...
  // Debug effect to track user and image changes
  useEffect(() => {
    console.group('UserDropdown Debug');
    console.log('User Object:', user);
    console.log('Is Logged In:', isLoggedIn);
    console.log('Profile Image in User:', user?.profileImage)
    console.groupEnd();


    // Update profile image when user object changes
